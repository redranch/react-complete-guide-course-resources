...
function CategoryDetails({ category, onBackClick }) {
  ...
  return (
    <div className="flex-1 p-8">
      <div className="w-full max-w-3xl">
        ...
        <div className="mb-6 p-4 rounded bg-black border-l-4 border-red-800">
          <h2 className="text-xl mb-2 text-white">Description</h2>
          <p className="text-gray-300">{category.description}</p>
        </div>
        
        <div className="p-4 rounded bg-black">
          <h2 className="text-xl mb-2 text-white">Due Date</h2>
          <p className="text-red-700 font-bold">{formattedDate}</p>
        </div>
      </div>
    </div>
  );
